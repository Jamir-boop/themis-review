...
- **Reglas de revisión**: convención de nombres `<alcance><Tipo><NombreCamel>` del core_framework, Message Boxes que bloquean ejecución desatendida (o que nunca abren), catch vacíos, rutas hardcodeadas, código deshabilitado, variables sin usar o sin descripción, dependencias faltantes, cobertura de logs y comentarios.
